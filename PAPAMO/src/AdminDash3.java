 ...
 * @author Erlan
 */
public class AdminDash3 extends javax.swing.JFrame {

    /**
     * Creates new form AdminDash3
     */
    public AdminDash3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        enrollList = new javax.swing.JTable();
        ...
        enroll.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        enroll.setForeground(new java.awt.Color(255, 255, 255));
        enroll.setText("ENROLLMENT:");
        jPanel2.add(enroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, -1, -1));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 0, 930, 70));

        enrollList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "LRN", "First Name", "Middle Initial", "Last Name", "Address", "Strand"
            }
        ));
        jScrollPane1.setViewportView(enrollList);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 90, 640, 420));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminDash3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminDash3().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable enrollList;
