...
public class AdminDash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        StudName.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        StudName.setForeground(new java.awt.Color(255, 255, 255));
        StudName.setText("STUDENT:");
        jPanel2.add(StudName, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, -1, -1));
        ...
        StudList.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "LRN", "Name", "Strand", "Section", "Attendance", "Grades"
            }
        ));
        jScrollPane1.setViewportView(StudList);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 80, 680, 440));
